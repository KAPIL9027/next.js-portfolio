     ...
     items-center space-y-7 flex-shrink-0 bg-[#292929] 
      ...
      hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden">
       ...
       <div className="px-0 md:px-10">
        ...
        <p className="font-bold text-[1.1rem] text-2xl">Ecredit India Pvt. Ltd.</p>
        ...
        <p className="uppercase py-5 text-[0.7rem] text-gray-300">Started work...-Ended...</p>
        <ul className="list-disc space-y-4 ml-5">
          <li className="text-[0.6rem] sm:text-[0.7rem]">Summary pointsSummary pointsSummary pointsSummary points</li>
          <li className="text-[0.6rem] sm:text-[0.7rem]">Summary pointsSummary pointsSummary pointsSummary pointsSummary points</li>
          <li className="text-[0.6rem] sm:text-[0.7rem]">Summary pointsSummary pointsSummary pointsSummary pointsSummary points</li>
          <li className="text-[0.6rem] sm:text-[0.7rem]">Summary pointsSummary pointsSummary pointsSummary pointsSummary points</li>
        </ul>
        </div>
